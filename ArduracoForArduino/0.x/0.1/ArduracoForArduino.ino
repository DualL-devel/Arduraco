...
void setup() {                
 ...
 delay(1000);
  ...
  XpressNet.start(XNetAddress,3);    //Initialisierung XNet-Bus

  XpressNet.setPower(csNormal);
  #if SerialDEBUG
  Debug.print("Power: ");
  Debug.println(XpressNet.getPower());
  #endif
}
...
void loop() {
  ...
  if(currentMillis - previousMillisA > interval) {
    ...
    */
    ...
    XpressNet.setLocoDrive(0x00, 0x03, 0x03, 50);
    XpressNet.getLocoInfo(0x00, 0x03);
    
    
/*    
    XpressNet.setHalt();			//Zusktand Halt Melden
